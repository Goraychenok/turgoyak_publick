...
/***/ "./markup/components/b-features/b-features.js":
/*!****************************************************!*\
  !*** ./markup/components/b-features/b-features.js ***!
  \****************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  const heightBlock = document.querySelector(".b-features__card").offsetHeight;
  $(".b-features__card-block").css({
    height: heightBlock
  });
  const widthInnerBlock = parseInt(getComputedStyle(document.querySelector(".b-features__grid"), null).getPropertyValue("width"));
  const widthUnderBlock = document.querySelector(".b-features__card-block").offsetWidth - 1;
  const heightBlockFeatures = document.querySelector(".b-features__content").offsetHeight;
  const slideHeight = document.querySelector(".b-features__slide").offsetHeight;
  const slider = $(".b-features__slider");
  console.log(slideHeight);

  if (screenWidth > 1023) {
    const afterBlock = heightBlockFeatures + 85 - heightBlock;
    $(".b-features__grid").css({
      width: widthInnerBlock
    });
    $(".b-features__card").css({
      width: widthUnderBlock,
      top: afterBlock
    });
  } else if (screenWidth > 575) {
    const afterBlock = heightBlockFeatures + 45 - heightBlock;
    $(".b-features__grid").css({
      width: widthInnerBlock
    });
    $(".b-features__card").css({
    ...
    const heightBlockSlider = document.querySelector(".b-features__content").offsetHeight;
    const afterBlock = heightBlockSlider + 25 - slideHeight;
    $(slider).css({
      top: afterBlock
    });
    $(".b-features__swiper-container").css({
      height: "100%",
      width: "100%"
    });
    initSlider();
...
/***/ "./markup/components/b-main-slider/b-main-slider.js":
/*!**********************************************************!*\
  !*** ./markup/components/b-main-slider/b-main-slider.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var swiper = new Swiper(`.${context} .mySwiper`, {
    ...
    navigation: {
      nextEl: '.b-main-slider .b-slider-nav__btn_next',
      prevEl: '.b-main-slider .b-slider-nav__btn_prev'
    },
    breakpoints: {
      768: {
        navigation: {
...
/***/ "./markup/components/b-numbers/b-numbers.js":
/*!**************************************************!*\
  !*** ./markup/components/b-numbers/b-numbers.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  const screenWidth = window.screen.width;
  const numbers = document.querySelector(".b-numbers");

  if (screenWidth < 768) {
    const sizeItem = Math.floor((screenWidth - 10) / 2) + "px";
    numbers.style.setProperty("--inside-size", sizeItem);
  } else if (screenWidth < 1500 && screenWidth >= 768) {
    const sizeItem = Math.floor((screenWidth - 10) / 4) + "px";
    numbers.style.setProperty("--inside-size", sizeItem);
  }
});
...
/***/ "./markup/components/b-our-apartments/b-our-apartments.js":
/*!****************************************************************!*\
  !*** ./markup/components/b-our-apartments/b-our-apartments.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/***/ "./markup/components/b-plans-slider/b-plans-slider.js":
/*!************************************************************!*\
  !*** ./markup/components/b-plans-slider/b-plans-slider.js ***!
  \************************************************************/
/*! exports provided: default */
...
/***/ "./markup/components/b-tabs-slider/b-tabs-slider.js":
/*!**********************************************************!*\
  !*** ./markup/components/b-tabs-slider/b-tabs-slider.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/***/ "./markup/components/b-tabs/b-tabs.js":
/*!********************************************!*\
  !*** ./markup/components/b-tabs/b-tabs.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./markup/components/b-two-img/b-two-img.js":
/*!**************************************************!*\
  !*** ./markup/components/b-two-img/b-two-img.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  const screenWidth = window.screen.width;
  const heightBlock = document.querySelector('.b-two-img__content').scrollHeight;
  const heightMainBLock = document.querySelector('.b-main-block').offsetHeight;
  const containerWidth = document.querySelector('.b-main-block__container').offsetWidth;

  if (screenWidth > 1500) {
    const newHeightBlock = heightBlock - 150;
    const positionTop = heightMainBLock - 150;
    $('.page__b-two-img').css({
    ...
    const heightBlockTest = document.querySelector('.b-two-img__content').scrollHeight;
    if (heightBlockTest > heightBlock) $('.page__b-two-img').css({
      'height': heightBlockTest - 150
    });
  } else if (screenWidth > 575) {
    const newHeightBlock = heightBlock - 150;
    const positionTop = heightMainBLock - 150;
    ...
    const newHeightBlock = heightBlock - 50;
    const positionTop = heightMainBLock - 50;
    $('.page__b-two-img').css({
      'height': newHeightBlock
    });
    $('.b-two-img').css({
...
/***/ "./markup/components/b-visual-floor/b-visual-floor.js":
/*!************************************************************!*\
  !*** ./markup/components/b-visual-floor/b-visual-floor.js ***!
  \************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  $(`.${context}__contour`).on("mouseenter", function (e) {
    ...
    let html = "";
    items.forEach(n => {
      html += `<div class="b-visual-floor__add-item"><div class="b-visual-floor__add-count">${n.name}</div> <div class="b-visual-floor__add-text">${n.text}</div></div>`;
    });
  ...
  const screenWidth = window.screen.width;
  const heightBlock = document.querySelector(".b-visual-floor").offsetHeight;
  const heightMainBlock = document.querySelector(".page__b-main-block").offsetHeight;
  const blackBlock = $(".b-visual-floor");
  const parent = $(".page__b-visual-inner");
  ...
  if (screenWidth) {
    ...
    const heightBlockTest = document.querySelector('.b-visual-floor').scrollHeight;
...
/***/ "./markup/components/b-visual/b-visual.js":
/*!************************************************!*\
  !*** ./markup/components/b-visual/b-visual.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  $(`.${context}__contour`).on('mouseenter', function (e) {
    ...
    items.forEach(n => {
      html += `
<div class="b-visual__add-item"><div class="b-visual__add-count">${n.name}</div> <div class="b-visual__add-text">${n.text}</div>
                                                                 </div>
            `;
    });
  ...
  //     "scrollx": $('.b-visual-floor__scroll-x'),
  // });;
});
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  $(`.page-header__burger-wrap`).on("click", function () {
    const burger = $(`.page-header__gamburger`);
    const mobileMenu = $(this).closest('.page-header').find('.page-header__mobile-menu');

    if ($(burger).hasClass("page-header__gamburger_open")) {
      $(burger).removeClass("page-header__gamburger_open");
      $(mobileMenu).slideUp();
      $('html, body').css('overflow', '');
    } else {
      $(burger).addClass("page-header__gamburger_open");
...
/* harmony import */ var components_b_main_slider_b_main_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! components/b-main-slider/b-main-slider */ "./markup/components/b-main-slider/b-main-slider.js");
/* harmony import */ var components_b_our_apartments_b_our_apartments__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! components/b-our-apartments/b-our-apartments */ "./markup/components/b-our-apartments/b-our-apartments.js");
/* harmony import */ var components_b_features_b_features__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! components/b-features/b-features */ "./markup/components/b-features/b-features.js");
/* harmony import */ var components_b_plans_slider_b_plans_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! components/b-plans-slider/b-plans-slider */ "./markup/components/b-plans-slider/b-plans-slider.js");
/* harmony import */ var components_b_numbers_b_numbers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! components/b-numbers/b-numbers */ "./markup/components/b-numbers/b-numbers.js");
/* harmony import */ var components_b_two_img_b_two_img__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! components/b-two-img/b-two-img */ "./markup/components/b-two-img/b-two-img.js");
/* harmony import */ var components_b_visual_floor_b_visual_floor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! components/b-visual-floor/b-visual-floor */ "./markup/components/b-visual-floor/b-visual-floor.js");
/* harmony import */ var components_b_tabs_b_tabs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! components/b-tabs/b-tabs */ "./markup/components/b-tabs/b-tabs.js");
/* harmony import */ var components_b_visual_b_visual__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! components/b-visual/b-visual */ "./markup/components/b-visual/b-visual.js");
/* harmony import */ var components_b_tabs_slider_b_tabs_slider__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! components/b-tabs-slider/b-tabs-slider */ "./markup/components/b-tabs-slider/b-tabs-slider.js");
...
$(document).ready(function () {
  ...
  Object(components_b_main_slider_b_main_slider__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(components_b_our_apartments_b_our_apartments__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(components_b_features_b_features__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(components_b_plans_slider_b_plans_slider__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(components_b_numbers_b_numbers__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(components_b_two_img_b_two_img__WEBPACK_IMPORTED_MODULE_8__["default"])();
  ...
  Object(components_b_tabs_b_tabs__WEBPACK_IMPORTED_MODULE_10__["default"])();
  Object(components_b_tabs_slider_b_tabs_slider__WEBPACK_IMPORTED_MODULE_12__["default"])();
